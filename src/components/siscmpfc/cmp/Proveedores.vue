          ...
          >
            <template v-slot:top>
              <v-toolbar flat color="white">
                ...
                ></v-text-field>
                <v-spacer></v-spacer>
                <v-btn color="warning" dark class="bm-2" @click="iniciar"
                    ...
                    <v-card>
                      ...
                      <v-card-actions>
                        ...
                        <v-btn color="blue darken-1" text @click="close"
                          >Cancelar</v-btn
                        >
                        <v-btn color="pink accent-3" :disabled="!formValido" text @click="save"
                          >Guardar</v-btn
                        >
                      </v-card-actions>
                    </v-card>
...
export default {
  ...
  computed: {
    formTitle() {
      return (this.editedIdex === -1 ? "Nueva" : "Editar") + " Proveedor";
    },
  },
  watch: {
    dialog(val) {
    ...
    async deleteItem(item) {
      this.$swal({
        ...
        if (result.value) {
          ...
          this.$swal(
            "Borrado",
            "Se borró satisfactoriamente el proveedor",
            "success"
          );
        } else {
